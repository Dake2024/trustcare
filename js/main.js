document.addEventListener('DOMContentLoaded', () => {
  ...
  const reviewsByTab = {
    big: [
      {
        company: 'Eyemax',
        author: 'Азиза, администратор глазной клиники Коновалова Eyemax',
        text: 'Начали работать с TrustMe - теперь все подписания проходят онлайн. Работа с документами стала заметно быстрее, а пациентам больше не нужно тратить лишнее время. Все документы системно хранятся и легко находятся, рады, что перешли на цифровой формат.',
        video: 'https://www.youtube.com/embed/MRqP5cO_85g?rel=0'
      },
      {
        company: 'Doctor Dent',
